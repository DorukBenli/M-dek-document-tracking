...
$numMidterms = getNumMidtermsForCourse($course['term'], $course['crn']); // Example: Number of midterms for the course
$hasFinalExam = hasFinalExam($course['term'], $course['crn']); // Assuming $term and $crn are the term and CRN of the course
$numHWs = getNumHWsForCourse($course['term'], $course['crn']);
$numQuizzes = getNumQuizzesForCourse($course['term'], $course['crn']);
$numOthers = getNumOthersForCourse($course['term'], $course['crn']);
?>
