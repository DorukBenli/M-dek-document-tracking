                                    ...
                                    <tr>
                                        <td>
                                            <form action="../routes/router.php?action=store_term_session" method="post" name="store_term_seesion">
                                                ...
                                                <input type="submit" value="My Courses" style="background-color: #7d96aa; color: white; border: 2px solid #7d96aa; cursor: pointer;">
                                            </form>
                                        </td>
                                        <td>
                                            <div style="position: absolute; top: 100px; left: 160px;">
                                                <form action="../routes/router.php?action=logout" method="post" name="logout">
                                                    <input type="submit" value="Log Off" style="background-color: #7d96aa; color: white; border: 2px solid #7d96aa; cursor: pointer;">
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
